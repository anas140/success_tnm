...
///////////faq edit///////////
    ...
    public function language_count_and_get($add_more_length = 1) {
          ...
          $html .= 
                    '<div class="module-form">
                        ...
                        <div class="j-input">
                            ...
                            <input type="text" class="module_name_value" id="" name="module_title[]" placeholder="Module 1" value="" >
                    ...
                    <div class="j-span3 j-unit">
                        <div class="j-input j-append-small-btn">
                            <div class="j-file-button">
                                Browse
                                <input type="file" name="module_pdf[]">
                            </div>
                    ...
                    <div class="j-row">
                        <div class="j-span3 j-unit">
                            <div class="j-input">
                                <input type="text" id="module_video_url[]" name="module_video_url[]" placeholder="Youtube Url" value="">
                                <span class="j-tooltip j-tooltip-right-top">Youtube Video Url</span>
                            </div>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="">
                            <button type="button" class="btn-link addSubModule" style="margin-top: 26px;float: left;">Add Sub Module</button>
                        </div>
                    </div>
        ...
        $addMoreHtml = '
            <div class="pull-right">
                <button type="button" class="btn btn-link" onclick="addMoreModule('.$id.')">Add More Module</button>
            </div>';
    ...
    public function add_module() {
       ...
       echo  $count = count($this->input->post('course_module'));exit;
